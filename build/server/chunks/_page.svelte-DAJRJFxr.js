import { N as ensure_array_like, S as escape_html, n as pop, p as push, E as fallback, F as slot, J as store_get, K as unsubscribe_stores, G as bind_props, m as setContext, L as rest_props, I as attr, O as spread_attributes, M as spread_props, P as sanitize_props, T as getContext } from './index-CohHun4k.js';
import { c as createMutation, L as LoadingButton } from './LoadingButton-BXWg8Mo7.js';
import { g as buttonVariants } from './index6-aGGGTMWB.js';
import { a as omit, w as withGet, m as makeElement, e as executeCallbacks, b as addMeltEventListener, s as styleToString, u as useEscapeKeydown, c as effect, p as portalAttr, d as createElHelpers, k as kbd, n as noop, t as tick, i as isBrowser, f as isFunction, g as isHTMLElement, h as addEventListener, j as isElement } from './create-P9acJvsF.js';
import { d as derived, a as readonly, w as writable } from './index3-C-znNAUp.js';
import { c as createBitAttrs, r as removeUndefined, g as getOptionUpdater, t as toWritableStores } from './updater-CaMd3WsH.js';
import { f as flyAndScale, c as cn } from './utils-GiUy8APZ.js';
    ...
    children: ($$payload2) => {
      ...
      Dialog_content($$payload2, {
        ...
        children: ($$payload3) => {
          ...
          $$payload3.out += `<!--]--> <span class="text-lg text-center">ท่านได้เลือกผู้สมัคร <span class="text-[#526D82] font-bold">เบอร์ ${escape_html(candidateNumber)}</span></span></div> <div class="flex flex-col bg-[#526D82] w-full rounded-lg p-2 text-center text-white"><span class="text-2xl font-bold">${escape_html(name2)}</span> <span>พรรค${escape_html(partyName)}</span></div> <img${attr("src", image)} width="250" height="250"${attr("alt", `${name2}`)} class="rounded-lg"> <span class="text-red-500">กรุณาตรวจสอบข้อมูลก่อนยืนยัน</span> `;
          if (isVoted) {
            $$payload3.out += "<!--[-->";
...
//# sourceMappingURL=_page.svelte-DAJRJFxr.js.map
