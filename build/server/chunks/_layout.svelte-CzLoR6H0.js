import { n as pop, E as fallback, F as slot, G as bind_props, p as push, I as attr, J as store_get, K as unsubscribe_stores, L as rest_props, M as spread_props, N as ensure_array_like, O as spread_attributes, P as sanitize_props, Q as add_styles, R as merge_styles, S as escape_html } from './index-DelxRFK-.js';
import { f as focusManager, o as onlineManager, r as resolveStaleTime, a as functionalUpdate, n as notifyManager, b as noop, h as hashKey, p as partialMatchKey, c as hashQueryKeyByOptions, s as skipToken, d as setQueryClientContext, S as Subscribable, m as matchQuery, M as Mutation, e as matchMutation, R as Removable, g as replaceData, i as resolveEnabled, t as timeUntilStale, j as createRetryer, k as ensureQueryFn, B as Button, l as isCancelledError, q as canFetch, u as addToStart, v as addToEnd } from './button-BVef6Cdd.js';
import { b as buttonVariants } from './index6-CiOtjUNN.js';
import { p as page } from './stores-CP9uf3zP.js';
import { I as Icon$1 } from './Icon-D4DBTRDJ.js';
import { V as Vote } from './vote-BzzoI0xK.js';
import { o as onDestroy } from './bundle-mjs-BtH-axbQ.js';
import { g as get, d as derived, w as writable } from './index3-BqMKRLPk.js';
import './utils-LN02QbR0.js';
...
function MobileNavbar($$payload, $$props) {
  ...
  Button($$payload, {
    ...
    disabled: true,
    children: ($$payload2) => {
      Chart_bar_big($$payload2, {});
    },
    $$slots: { default: true }
  });
  $$payload.out += `<!----></li> <li><a href="/vote"${attr("class", buttonVariants({
...
//# sourceMappingURL=_layout.svelte-CzLoR6H0.js.map
