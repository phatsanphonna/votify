import { N as ensure_array_like, U as head, S as escape_html, n as pop, p as push, E as fallback, F as slot, J as store_get, K as unsubscribe_stores, G as bind_props, m as setContext, L as rest_props, I as attr, O as spread_attributes, M as spread_props, P as sanitize_props, T as getContext } from './index-DelxRFK-.js';
...
import { a as omit, w as withGet, m as makeElement, e as executeCallbacks, b as addMeltEventListener, s as styleToString, u as useEscapeKeydown, c as effect, p as portalAttr, d as createElHelpers, k as kbd, n as noop, t as tick, i as isBrowser, f as isFunction, g as isHTMLElement, h as addEventListener, j as isElement } from './create-DOlC2Afs.js';
import { d as derived, a as readonly, w as writable } from './index3-BqMKRLPk.js';
import { c as createBitAttrs, r as removeUndefined, g as getOptionUpdater, t as toWritableStores } from './updater-C9Fb9RgZ.js';
import { f as flyAndScale, c as cn } from './utils-Cwet9JSK.js';
...
function Cross2($$payload, $$props) {
  ...
  $$payload.out += `<!--]--><path fill-rule="evenodd" clip-rule="evenodd" d="M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z"></path></svg>`;
  pop();
}
...
function CandidateCard($$payload, $$props) {
  push();
  var $$store_subs;
  let {
    image,
  ...
  Root($$payload, {
    ...
    children: ($$payload2) => {
      Trigger($$payload2, {
        class: "bg-[#DDE6ED] h-52 p-4 rounded-lg flex flex-col gap-2 item-center",
        children: ($$payload3) => {
          $$payload3.out += `<div class="relative"><img${attr("src", image)} width="150" height="150"${attr("alt", `${name2}`)} class="rounded-lg"> <p class="absolute bottom-2 right-2 text-4xl font-bold bg-white rounded-full px-2">${escape_html(candidateNumber)}</p></div> <span class="text-center w-full">${escape_html(name2)}</span>`;
        },
        $$slots: { default: true }
      });
      $$payload2.out += `<!----> `;
      Dialog_content($$payload2, {
        ...
        children: ($$payload3) => {
          $$payload3.out += `<div class="flex flex-col">`;
          if (isVoted) {
            $$payload3.out += "<!--[-->";
            $$payload3.out += `<span class="text-2xl text-center font-bold text-[#509A71]">เลือกตั้งสำเร็จ</span>`;
          } else {
            $$payload3.out += "<!--[!-->";
          }
          $$payload3.out += `<!--]--> <span class="text-lg text-center">ท่านได้เลือกผู้สมัคร <span class="text-[#526D82] font-bold">เบอร์ ${escape_html(candidateNumber)}</span></span></div> <div class="flex flex-col bg-[#526D82] w-full rounded-lg p-2 text-center text-white"><span class="text-2xl font-bold">${escape_html(name2)}</span> <span>พรรค${escape_html(partyName)}</span></div> <img${attr("src", image)} width="250" height="250"${attr("alt", `${name2}`)} class="rounded-lg"> `;
          if (!isVoted) {
            $$payload3.out += "<!--[-->";
            $$payload3.out += `<span class="text-red-500">กรุณาตรวจสอบข้อมูลก่อนยืนยัน</span>`;
          } else {
            $$payload3.out += "<!--[!-->";
          }
          $$payload3.out += `<!--]--> `;
          if (isVoted) {
            ...
            Dialog_footer($$payload3, {
              class: "flex flex-row justify-between w-full gap-2",
              children: ($$payload4) => {
                Close($$payload4, {
                  class: buttonVariants({ className: "w-full", variant: "secondary" }),
                  children: ($$payload5) => {
                    $$payload5.out += `<!---->กลับสู่หน้าหลัก`;
                  },
                  $$slots: { default: true }
                });
              },
            ...
            Dialog_footer($$payload3, {
              ...
              children: ($$payload4) => {
                ...
                $$payload4.out += `<!----> `;
                LoadingButton($$payload4, {
                  isLoading: store_get($$store_subs ??= {}, "$mutate", mutate).isPending,
                  class: "w-full",
                  onclick: async () => store_get($$store_subs ??= {}, "$mutate", mutate).mutateAsync(),
                  children: ($$payload5) => {
                    $$payload5.out += `<!---->ยืนยัน`;
                  },
                  $$slots: { default: true }
...
function VoteStatusCard($$payload, $$props) {
  ...
  if (isVoted) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<p class="text-sm">คุณได้ใช้สิทธิ์การเลือกตั้งแล้ว <span class="text-[#0F996D] font-bold">เมื่อ ${escape_html(votedAt?.toLocaleString())}</span></p>`;
  } else {
    $$payload.out += "<!--[!-->";
...
function _page($$payload, $$props) {
  push();
  let { data } = $$props;
  const each_array = ensure_array_like(data.candidates);
  head($$payload, ($$payload2) => {
    $$payload2.title = `<title>คูหาออนไลน์</title>`;
  });
  ...
  $$payload.out += `<!----> <div><p class="text-center text-2xl font-bold">รายชื่อผู้สมัครเลือกตั้ง${escape_html(data.area.name)}</p> <p class="text-center">ท่านสามารถเลือกได้เพียง <span class="font-bold text-[#C91313]">1 ครั้ง</span> เท่านั้น</p></div> <div class="grid grid-cols-2 gap-4"><!--[-->`;
  for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
    let candidate = each_array[$$index];
    CandidateCard($$payload, {
...
//# sourceMappingURL=_page.svelte-DioD6BqB.js.map
